...
eps <- 0.35
min_points <- 10
dbscan_fit <- dbscan(penguins_std, eps = eps, min_points = min_points)
...
penguins_new$cp <- factor(if_else(as.numeric(is.corepoint(penguins_std, eps = eps, min_points = min_points)) == 1, "Yes", "No"), levels = c("Yes", "No"))
