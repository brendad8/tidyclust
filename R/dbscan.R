...
#' @description
#'
#' `dbscan` defines a model that fits clusters based on areas with observations
#' that are densly packed together
#'
...
#'
#' @return A `dbscan` cluster specification.
#'
#' @examples
#' # Show all engines
#' modelenv::get_from_env("dbscan")
#'
#' dbscan()
#' @export
dbscan <-
...
#' @method update dbscan
#' @rdname tidyclust_update
#' @export
update.dbscan <- function(object,
                              parameters = NULL,
                              radius = NULL,
                              minpts = NULL,
                              fresh = FALSE, ...) {
...
#' @export
check_args.dbscan <- function(object) {
